                ...
                <form id="mark-blog" class="am-form am-form-horizontal" method="post" action="{{url('/center/blog/edit_blog')}}" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="am-form-group am-form-file">
                            ...
                            <img width="40%" height="40%" src="{{asset($article -> image)}}" alt="">
                            <div>
                        ...
                        <div class="am-form-group">
                            ...
                            <label class="am-radio-inline">
                                <input type="radio" @if ($article -> is_open == 1) checked @endif   value="1" name="is_open"> 显示
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" @if ($article -> is_open == 2) checked @endif value="2" name="is_open"> 隐藏
                            </label>
                        </div>
