...
<header>
    ...
    <div class="log-re">
        <a href="{{url('/register')}}" style="color: white;" class="am-btn am-btn-default am-radius log-button">注册</a>
    </div>
</header>
        ...
        <div class="am-u-lg-3 am-u-md-6 am-u-sm-8 am-u-sm-centered log-content">
            ...
            <form class="am-form" id="log-form">
                ...
                <div class="am-input-group am-animation-slide-left log-animation-delay">
                    <input type="password" class="am-form-field am-radius log-input" placeholder="请输入6-18位密码" maxlength="18" required>
                    <span class="am-input-group-label log-icon am-radius"><i class="am-icon-lock am-icon-sm am-icon-fw"></i></span>
                </div>
                <br>
                <button type="button" class="am-btn am-btn-primary am-btn-block am-btn-lg am-radius am-animation-slide-bottom log-animation-delay">登 录</button>
                <p class="am-animation-slide-bottom log-animation-delay"><a href="{{url('/forget')}}">忘记密码?</a></p>
...
<script>
    ...
    $('button[type=button]').click(function(){
        ...
        if (!validate('password', pwd)) {
            ...
            $('input[type=password]').parent().append(dang);
        }
        pwd = $.md5($.sha1($.md5(pwd)) + pass_hash);
        $.post('/api/login', {email:account, password:pwd}, function(json){
            if (json.code != 200) {
                console.log(json);
