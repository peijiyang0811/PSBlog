    ...
    <div class="am-u-sm-10 am-u-md-10 am-u-lg-10 am-u-lg-offset-1">
        <div class="widget am-cf">
            <div class="widget-head am-cf">
                <div class="widget-title am-fl">编辑友链</div>
            </div>
            <div class="widget-body am-fr">
                ...
                <form action="{{url('admin/links/update')}}" method="post" class="am-form tpl-form-border-form" enctype="multipart/form-data">
                    ...
                    <div class="am-form-group am-form-icon am-form-feedback">
                        ...
                        <div style="float: left" class="am-form-group am-u-sm-8 am-u-lg-8 am-u-md-8">
                            <input type="text" value="{{$link -> title}}" class="am-form-field tpl-form-input am-margin-top-xs am-radius" name="title" placeholder="">
                    ...
                    <div class="am-form-group">
                        ...
                        <div style="float: left" class="am-u-sm-8 am-u-lg-8 am-u-md-8">
                            <input type="text" value="{{$link -> site_url}}" class="am-form-field tpl-form-input am-margin-top-xs am-radius" name="site_url" placeholder="">
                    ...
                    <div class="am-form-group">
                        ...
                        <div style="float: left" class="am-u-sm-8 am-u-lg-8 am-u-md-8">
                            <input type="text" value="{{$link -> contact_name}}" class="am-form-field tpl-form-input am-margin-top-xs am-radius" name="contact_name" placeholder="">
                            <small>请填写汉字</small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div style="float: left" class="am-u-sm-8 am-u-lg-8 am-u-md-8">
                            <input type="text" value="{{$link -> contact_qq}}" class="am-form-field tpl-form-input am-margin-top-xs am-radius" name="contact_qq" placeholder="">
                    ...
                    <div class="am-form-group">
                        ...
                        <div style="float: left" class="am-u-sm-8 am-u-lg-8 am-u-md-8">
                            <input type="text" value="{{$link -> contact_phone}}" class="am-form-field tpl-form-input am-margin-top-xs am-radius" name="contact_phone" placeholder="">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-margin-top-xs">
                            <div class="am-form-group am-form-file">
                                <img src="{{asset($link -> site_logo)}}">
                                <input type="hidden" name="old_logo" value="{{$link -> site_logo}}">
                    ...
                    <div class="am-form-group">
                        <label for="user-weibo" class="am-u-sm-12 am-form-label  am-text-left">状态 <span class="tpl-form-line-small-title"></span></label>
                        <div class="am-u-sm-12 am-margin-top-xs">
                            <label class="am-radio-inline">
                                <input type="radio" name="status" value="1" @if($link -> status == 1) checked @endif name="docInlineRadio"> 启用
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" name="status" value="2" @if($link -> status == 2) checked @endif name="docInlineRadio"> 禁用
                            </label>
                        </div>
                    </div>
                    <div class="am-form-group">
