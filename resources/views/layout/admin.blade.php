...
<head>
    ...
    <title>@yield('title')--PS伐木累后台管理系统</title>
    ...
    <meta name="apple-mobile-web-app-title" content="PS伐木累"/>
...
<div class="am-g tpl-g">
    ...
    <header>
        ...
        <div class="am-fl tpl-header-logo">
            <a href="javascript:;"><img src="{{asset('/images/logo/header_logo.png')}}" alt="首页"></a>
        </div>
        <!-- 右侧内容 -->
            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <?php
                        $user = cache('admin_user_id' . session('admin_user_id'));
                        $user = json_decode($user);
                        ?>
                        <?php if ($user) {?>
                        <a href="javascript:;">欢迎您, <span>{{$user -> real_name}}</span> </a>
                        <?php }?>
                    </li>
        ...
        <div class="tpl-sidebar-user-panel">
            <div class="tpl-user-panel-slide-toggleable">
              ...
              <i class="am-icon-circle-o am-text-success tpl-user-panel-status-icon"></i>
                ...
                <a href="javascript:;" class="tpl-user-panel-action-link"> <span class="am-icon-clock-o am-icon-sm"></span> </a>
            </div>
        </div>
    ...
    <!-- 内容区域 -->
    <div class="tpl-content-wrapper" style="top:10px">
